...
kruger$geometry = kruger$geometry * rot(pi / -6)
...
rivers$geometry = rivers$geometry * rot(pi /-6)

# waterholes
waterholes <- st_read("data/waterholes/")
waterholes$geometry = waterholes$geometry * rot(pi /-6)
```
